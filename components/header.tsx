...
export default function header() {
  return (<header className="z-[999] relative">
    ...
    bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blue-[0.5rem]
    ...
    <nav className="flex fixed top-[0.15rem] left-1/2 
    h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] 
    sm:h-[initial] sm:py-0">
        <ul className="flex w-[22rem] flex-wrap
        items-center justify-center gap-y-1 text-[0.
        9rem] font-medium text-gray-500 sm:w-[initial]
